 ...
 */
@WebServlet(name = "updateAdresU", value = "/updateAdresU")
public class updateAdresU extends HttpServlet{
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try{
            ...
            int i = new AddressDAO().UpdateAddress(o.getPhysicalAddressOrganization(), req.getParameter("city"), req.getParameter("street"),
