 ...
 */
@WebServlet(name = "getAdressF", value = "/getAdressF")
public class getAddressF extends HttpServlet{
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            Address a = new AddressDAO().getAddressById(o.getLegalAddressOrganization());
